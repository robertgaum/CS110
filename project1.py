        ...
        if CompNum == 2:   
            if inlist == True:
                ...
                if CompType == TypeList[0]:
                    ...
                    listcheck(CompType)
                    PrintType(CompNum,CompType)
                    comp_2.gitresistance()

                elif CompType == TypeList[4]:
                    comp_2 = LightBulb(0, 0, 0)
                    listcheck(CompType)
                    PrintType(CompNum,CompType)
                    comp_2.getlightstatus()
                    comp_2.getthreshold()
        ...
        if CompNum == 3:   
            if inlist == True:
                ...
                if CompType == TypeList[0]:
                    ...
                    listcheck(CompType)
                    PrintType(CompNum,CompType)
                    comp_3.gitresistance()

                elif CompType == TypeList[4]:
                    comp_3 = LightBulb(0, 0, 0)
                    listcheck(CompType)
                    PrintType(CompNum,CompType)
                    comp_3.getlightstatus()
                    comp_3.getthreshold()
        ...
        if CompNum == 4:   
            if inlist == True:
                ...
                if CompType == TypeList[0]:
                    ...
                    listcheck(CompType)
                    PrintType(CompNum,CompType)
                    comp_4.gitresistance()

                elif CompType == TypeList[4]:
                    comp_4 = LightBulb(0, 0, 0)
                    listcheck(CompType)
                    PrintType(CompNum,CompType)
                    comp_4.getlightstatus()
                    comp_4.getthreshold()
        ...
        if CompNum == 5:   
            if inlist == True:
                ...
                if CompType == TypeList[0]:
                    ...
                    listcheck(CompType)
                    PrintType(CompNum,CompType)
                    comp_5.gitresistance()

                elif CompType == TypeList[4]:
                    comp_5 = LightBulb(0, 0, 0)
                    listcheck(CompType)
                    PrintType(CompNum,CompType)
                    comp_5.getlightstatus()
                    comp_5.getthreshold()
